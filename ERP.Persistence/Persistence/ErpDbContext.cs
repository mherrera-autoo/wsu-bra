...
public class ErpDbContext : DbContext
{
    ...
    {
        modelBuilder.Entity<PharmaProductProfile>(entity =>
        {
            ConfigurePharmaTable(entity, "PharmaProductProfiles");
            entity.HasKey(e => e.Id);
            entity.Property(e => e.SaleCondition).IsRequired();
            entity.HasIndex(e => new { e.CompanyId, e.ProductId }).IsUnique();
            ConfigureCompanyReference(entity);
        });

        modelBuilder.Entity<ProductPharmaInfo>(entity =>
        {
            ConfigurePharmaTable(entity, "ProductPharmaInfos");
            entity.HasKey(e => e.Id);
            entity.Property(e => e.Laboratory).IsRequired().HasMaxLength(200);
            entity.Property(e => e.Presentation).IsRequired().HasMaxLength(100);
            entity.Property(e => e.ActiveIngredient).HasMaxLength(200);
            entity.Property(e => e.CenabastCode).HasMaxLength(64);
            entity.Property(e => e.Barcode).HasMaxLength(64);
            entity.HasIndex(e => new { e.CompanyId, e.ProductId }).IsUnique();
        ...
        {
            ConfigurePharmaTable(entity, "StockBatches");
            entity.HasKey(e => e.Id);
            ...
            entity.Property(e => e.RecallReason).HasMaxLength(500);
            entity.Property(e => e.WasteReason).HasMaxLength(500);
            entity.HasIndex(e => new { e.CompanyId, e.ProductId, e.WarehouseId, e.BatchNumber, e.ExpiryDate }).IsUnique();
            entity.HasIndex(e => new { e.CompanyId, e.ExpiryDate });
        ...
        {
            ConfigurePharmaTable(entity, "StockLedgerEntries");
            entity.HasKey(e => e.Id);
            entity.Property(e => e.Quantity).HasPrecision(18, 2);
            ...
            entity.HasIndex(e => new { e.CompanyId, e.ProductId, e.WarehouseId });
            entity.HasIndex(e => new { e.CompanyId, e.StockBatchId });
            ConfigureCompanyReference(entity);
        });

        modelBuilder.Entity<QuarantineHold>(entity =>
        {
            ConfigurePharmaTable(entity, "QuarantineHolds");
            entity.HasKey(e => e.Id);
            entity.Property(e => e.Status).IsRequired();
            entity.Property(e => e.Reason).IsRequired().HasMaxLength(500);
            entity.HasOne<StockBatch>()
                .WithMany()
        ...
        modelBuilder.Entity<BlockHold>(entity =>
        {
            ConfigurePharmaTable(entity, "BlockHolds");
            entity.HasKey(e => e.Id);
            entity.Property(e => e.Reason).IsRequired().HasMaxLength(500);
            entity.HasOne<StockBatch>()
                .WithMany()
        ...
        {
            ConfigurePharmaTable(entity, "Recalls");
            entity.HasKey(e => e.Id);
            entity.Property(e => e.Reason).IsRequired().HasMaxLength(500);
            entity.Property(e => e.Quantity).HasPrecision(18, 2);
            entity.HasOne<StockBatch>()
        ...
        {
            ConfigurePharmaTable(entity, "Wastes");
            entity.HasKey(e => e.Id);
            entity.Property(e => e.Reason).IsRequired().HasMaxLength(500);
            entity.Property(e => e.Quantity).HasPrecision(18, 2);
        ...
        modelBuilder.Entity<MovementBatchAllocation>(entity =>
        {
            ConfigurePharmaTable(entity, "MovementBatchAllocations");
            entity.HasKey(e => e.Id);
            entity.Property(e => e.Quantity).HasPrecision(18, 2);
        ...
        modelBuilder.Entity<PharmacyTraceEvent>(entity =>
        {
            ConfigurePharmaTable(entity, "PharmacyTraceEvents");
            entity.HasKey(e => e.Id);
            entity.Property(e => e.BatchNumber).IsRequired();
            entity.Property(e => e.Quantity).HasPrecision(18, 2);
            entity.Property(e => e.ReferenceType).IsRequired().HasMaxLength(64);
            entity.Property(e => e.ReferenceId).IsRequired().HasMaxLength(64);
            entity.Property(e => e.PatientReference).HasMaxLength(256);
            entity.Property(e => e.Reason).HasMaxLength(500);
            entity.HasOne(e => e.Movement)
                .WithMany()
                .HasForeignKey(e => e.MovementId)
                .OnDelete(DeleteBehavior.Restrict);
            entity.HasOne(e => e.MovementBatchAllocation)
                .WithMany()
                .HasForeignKey(e => e.MovementBatchAllocationId)
                .OnDelete(DeleteBehavior.Restrict);
            entity.HasOne(e => e.StockBatch)
                .WithMany()
                .HasForeignKey(e => e.StockBatchId)
                .OnDelete(DeleteBehavior.Restrict);
            entity.HasIndex(e => new { e.CompanyId, e.BatchNumber });
            entity.HasIndex(e => new { e.CompanyId, e.PatientReference });
            entity.HasIndex(e => new { e.CompanyId, e.SupplierId });
            ConfigureCompanyReference(entity);
        });

        modelBuilder.Entity<Dispense>(entity =>
        {
            ConfigurePharmaTable(entity, "Dispenses");
            entity.HasKey(e => e.Id);
            entity.Property(e => e.Date).IsRequired();
            entity.HasMany(e => e.Lines)
                .WithOne()
                .HasForeignKey(line => line.DispenseId)
                .OnDelete(DeleteBehavior.Cascade);
            entity.HasOne(e => e.Prescription)
                .WithOne()
                .HasForeignKey<Prescription>(prescription => prescription.DispenseId)
                .OnDelete(DeleteBehavior.Cascade);
            ConfigureCompanyReference(entity);
        });

        modelBuilder.Entity<DispenseLine>(entity =>
        {
            ConfigurePharmaTable(entity, "DispenseLines");
            entity.HasKey(e => e.Id);
            entity.Property(e => e.Quantity).HasPrecision(18, 2);
            ConfigureCompanyReference(entity);
        });
        ...
        {
            ConfigurePharmaTable(entity, "Prescriptions");
            entity.HasKey(e => e.Id);
        ...
        {
            ConfigurePharmaTable(entity, "PrescriptionItems");
            entity.HasKey(e => e.Id);
            entity.HasOne(e => e.DispenseLine)
                .WithOne()
                .HasForeignKey<PrescriptionItem>(e => e.DispenseLineId)
                .OnDelete(DeleteBehavior.Cascade);
            ConfigureCompanyReference(entity);
        });

        modelBuilder.Entity<OfficialControlledBookEntry>(entity =>
        {
            ConfigurePharmaTable(entity, "OfficialControlledBookEntries");
            entity.HasKey(e => e.Id);
            entity.Property(e => e.BatchNumber).IsRequired();
            entity.Property(e => e.ReferenceDocument).IsRequired();
            entity.Property(e => e.IspFolio);
            entity.Property(e => e.IspReason);
            entity.Property(e => e.IspOriginDestination);
            entity.Property(e => e.IspSupplierOrPatient);
            entity.Property(e => e.IspPrescriber);
            entity.Property(e => e.IspTaxReference);
            entity.Property(e => e.CreatedBy).IsRequired();
            entity.Property(e => e.Quantity).HasPrecision(18, 2);
            entity.HasIndex(e => new { e.CompanyId, e.Date });
            entity.HasIndex(e => new { e.CompanyId, e.ProductId, e.Date });
            ConfigureCompanyReference(entity);
        });

        modelBuilder.Entity<ControlledSubstanceLedger>(entity =>
        {
            ConfigurePharmaTable(entity, "ControlledSubstanceLedgers");
            entity.HasKey(e => e.Id);
            entity.Property(e => e.LedgerCode).IsRequired();
            entity.Property(e => e.OpenedAt).IsRequired();
            ConfigureCompanyReference(entity);
        });

        modelBuilder.Entity<ControlledSubstanceLedgerAudit>(entity =>
        {
            ConfigurePharmaTable(entity, "ControlledSubstanceLedgerAudits");
            entity.HasKey(e => e.Id);
            entity.Property(e => e.Action).IsRequired();
            entity.Property(e => e.RecordedBy).IsRequired();
            entity.Property(e => e.PayloadJson).IsRequired();
            entity.Property(e => e.OccurredAt).IsRequired();
            entity.HasOne<OfficialControlledBookEntry>()
                .WithMany()
                .HasForeignKey(e => e.OfficialControlledBookEntryId)
                .OnDelete(DeleteBehavior.Restrict);
            ConfigureCompanyReference(entity);
        });

        modelBuilder.Entity<ControlledSubstanceReportExport>(entity =>
        {
            ConfigurePharmaTable(entity, "ControlledSubstanceReportExports");
            entity.HasKey(e => e.Id);
            entity.Property(e => e.Format).IsRequired().HasMaxLength(32);
            entity.Property(e => e.ExportedBy).IsRequired().HasMaxLength(256);
            entity.HasIndex(e => new { e.CompanyId, e.ExportedAt });
            ConfigureCompanyReference(entity);
        });

        modelBuilder.Entity<PharmacyCriticalAudit>(entity =>
        {
            ConfigurePharmaTable(entity, "PharmacyCriticalAudits");
            entity.HasKey(e => e.Id);
            ...
            entity.HasIndex(e => new { e.CompanyId, e.EntityName });
            ConfigureCompanyReference(entity);
        });

        modelBuilder.Entity<ExpirationAlertRule>(entity =>
        {
            ConfigurePharmaTable(entity, "ExpirationAlertRules");
            entity.HasKey(e => e.Id);
            entity.HasIndex(e => new { e.CompanyId }).IsUnique();
            ConfigureCompanyReference(entity);
        });

        modelBuilder.Entity<StockoutThreshold>(entity =>
        {
            ConfigurePharmaTable(entity, "StockoutThresholds");
            entity.HasKey(e => e.Id);
            entity.Property(e => e.ThresholdQuantity).HasPrecision(18, 2);
            entity.HasIndex(e => new { e.CompanyId, e.ProductId, e.WarehouseId }).IsUnique();
            ConfigureCompanyReference(entity);
        });

        modelBuilder.Entity<PurchaseInvoiceIngestion>(entity =>
        {
            ConfigurePharmaTable(entity, "PurchaseInvoiceIngestions");
            entity.HasKey(e => e.Id);
            entity.Property(e => e.InvoiceNumber).IsRequired().HasMaxLength(64);
            entity.Property(e => e.QrPayload).HasMaxLength(1024);
            entity.Property(e => e.Status).HasConversion<string>().IsRequired().HasMaxLength(32);
            entity.HasIndex(e => new { e.CompanyId, e.InvoiceNumber }).IsUnique();
            entity.HasMany(e => e.Lines)
                .WithOne()
                .HasForeignKey(line => line.PurchaseInvoiceIngestionId)
                .OnDelete(DeleteBehavior.Cascade);
        ...
        modelBuilder.Entity<PurchaseInvoiceIngestionLine>(entity =>
        {
            ConfigurePharmaTable(entity, "PurchaseInvoiceIngestionLines");
            entity.HasKey(e => e.Id);
            entity.Property(e => e.Quantity).HasPrecision(18, 2);
            entity.Property(e => e.BatchNumber).HasMaxLength(64);
            entity.Property(e => e.InboundPresentation).HasConversion<string>().HasMaxLength(32);
            entity.OwnsOne(e => e.UnitPrice, owned =>
            {
                owned.Property(p => p.Amount).HasColumnName("UnitPriceAmount").HasPrecision(18, 2);
                owned.Property(p => p.Currency).HasColumnName("UnitPriceCurrency").HasMaxLength(3);
        ...
        {
            ConfigurePharmaTable(entity, "DeliveryConfirmations");
            entity.HasKey(e => e.Id);
            entity.Property(e => e.ReferenceType).IsRequired().HasMaxLength(64);
            entity.Property(e => e.ReferenceId).IsRequired().HasMaxLength(64);
            entity.Property(e => e.Carrier).HasMaxLength(128);
            entity.Property(e => e.ReceivedBy).HasMaxLength(128);
            entity.Property(e => e.Notes).HasMaxLength(500);
            entity.HasIndex(e => new { e.CompanyId, e.ReferenceType, e.ReferenceId });
            ConfigureCompanyReference(entity);
        });
    }

    private static void ConfigureWms(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<WarehouseLocation>(entity =>
        {
            ConfigureWmsTable(entity, "WarehouseLocations");
            entity.HasKey(e => e.Id);
            entity.Property(e => e.Aisle).IsRequired().HasMaxLength(50);
            ...
            entity.Property(e => e.Notes).HasMaxLength(500);
            entity.HasIndex(e => new { e.CompanyId, e.WarehouseId, e.Aisle, e.Rack, e.Side, e.Level, e.Slot }).IsUnique();
        ...
        {
            ConfigureWmsTable(entity, "WarehouseOperations");
            entity.HasKey(e => e.Id);
            entity.Property(e => e.ReferenceType).IsRequired().HasMaxLength(64);
            entity.Property(e => e.ReferenceId).IsRequired().HasMaxLength(64);
            entity.Property(e => e.Notes).HasMaxLength(500);
            entity.HasIndex(e => new { e.CompanyId, e.WarehouseId, e.ReferenceType, e.ReferenceId });
            entity.HasOne<Warehouse>()
                .WithMany()
                .HasForeignKey(e => e.WarehouseId)
                .OnDelete(DeleteBehavior.Restrict);
        ...
        modelBuilder.Entity<DispatchConfirmation>(entity =>
        {
            ConfigureWmsTable(entity, "DispatchConfirmations");
            entity.HasKey(e => e.Id);
            entity.Property(e => e.ReferenceType).IsRequired().HasMaxLength(64);
            entity.Property(e => e.ReferenceId).IsRequired().HasMaxLength(64);
            entity.Property(e => e.Carrier).IsRequired().HasMaxLength(128);
            entity.Property(e => e.DriverName).HasMaxLength(128);
            entity.Property(e => e.VehiclePlate).HasMaxLength(32);
            entity.Property(e => e.ReceivedBy).HasMaxLength(128);
            entity.Property(e => e.Notes).HasMaxLength(500);
            entity.HasIndex(e => new { e.CompanyId, e.ReferenceType, e.ReferenceId }).IsUnique();
            ConfigureCompanyReference(entity);
        });
    }

    private static void ConfigurePharmaTable<TEntity>(EntityTypeBuilder<TEntity> entity, string tableName)
        where TEntity : class
    {
        entity.ToTable(tableName, PharmaSchema);
    }
    ...
    private static void EnsurePharmaSchemaMappings(ModelBuilder modelBuilder)
    {
        var invalidEntities = modelBuilder.Model.GetEntityTypes()
            .Where(entityType => entityType.ClrType.Namespace == "ERP.Modules.PharmaceuticalRegulatedInventory.Domain"
                && !entityType.IsOwned())
            .Where(entityType => !string.Equals(entityType.GetSchema(), PharmaSchema, StringComparison.Ordinal))
            .Select(entityType => $"{entityType.ClrType.Name} -> {entityType.GetSchema() ?? "<default>"}")
            .ToList();
        ...
        throw new InvalidOperationException(
            $"Pharma entities must map to schema '{PharmaSchema}'. Invalid mappings: {string.Join(", ", invalidEntities)}");
    }
    ...
    {
        modelBuilder.Entity<FinanceAccountsReceivable>(entity =>
        {
            ...
            entity.OwnsOne(e => e.AmountDue, owned =>
            {
                owned.Property(p => p.Amount).HasColumnName("AmountDue").HasPrecision(18, 2);
                owned.Property(p => p.Currency).HasColumnName("AmountDueCurrency").HasMaxLength(3);
            });
            ConfigureCompanyReference(entity);
        });

        modelBuilder.Entity<FinanceAccountsPayable>(entity =>
        {
